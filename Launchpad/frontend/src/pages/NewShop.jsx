...
export default function NewShop() {
  ...
  // Poll the new shop until it finishes installing/building
          ...
          <div className="mt-3 flex items-center justify-center gap-2">
            {newShopStatus === 'running' ? (
              ...
              <>
                ...
                <span className="text-xs font-mono font-medium text-destructive">Error &mdash; check logs below</span>
              </>
            ) : (
              <>
                ...
                <span className="text-xs text-muted-foreground">
                  installing &amp; compiling &mdash; usually 2&ndash;3 minutes, the shop is not ready yet
                </span>
              </>
            )}
          </div>
