...
// Use memory storage so we can inspect/write the files ourselves
const upload = multer({
  storage: multer.memoryStorage(),
  limits: { fileSize: 10 * 1024 * 1024 }, // 10MB per file
});

// Resolve and validate that a path stays within the shop directory
...
// Upload one or more files into the given subdirectory of the shop
